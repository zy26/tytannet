...
namespace Pretorianie.Tytan.Core.Interfaces
{
    ...
    public interface IMenuCustomizator
    {
        ...
        /// </summary>
        void AddAuxToolWindow(string parentMenuName, MenuCommand menuCommand, bool beginGroup, int itemIndex, string afterItemCaption);
        ...
        /// </summary>
        void AddAboutItem(MenuCommand menuCommand, bool beginGroup, int itemIndex, string afterItemCaption);

        /// <summary>
        /// Registers new item inside 'Insert' popup.
        /// </summary>
        void AddInsertionItem(MenuCommand menuCommand, bool beginGroup, int itemIndex, string afterItemCaption);
