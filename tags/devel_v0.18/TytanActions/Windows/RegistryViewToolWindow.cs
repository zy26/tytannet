...
namespace Pretorianie.Tytan.Windows
{
    ...
    /// </summary>
    [Guid(GuidList.guidToolWindow_RegistryView)]
    public class RegistryViewToolWindow : ToolWindowPane
    {
       private IPackageToolWindow tool;
        ...
        /// </summary>
        public RegistryViewToolWindow()
            :
            base(null)
        {
            tool = new RegistryViewPackageTool();
