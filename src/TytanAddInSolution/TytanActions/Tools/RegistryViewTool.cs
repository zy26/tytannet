...
namespace Pretorianie.Tytan.Tools
{
    public partial class RegistryViewTool : UserControl
    {
        ...
        private void treeView_BeforeExpand(object sender, TreeViewCancelEventArgs e)
        {
                ...
                if (e.Node != null)
                {
                    ...
                    if (names != null)
                        foreach (string name in names)
                        {
                            ...
                            {
                                e.Node.Nodes.Add(new TreeNode(name + SharedStrings.RegistryView_NotAccessible, UnaccessibleNodeImageIndex, UnaccessibleNodeImageIndex));
                            }
                        }
            ...
            {
                if (!e.Node.Text.EndsWith(SharedStrings.RegistryView_NotAccessible))
                {
        ...
        {
            ConfigHelper.SendFeedback(this);
        }
